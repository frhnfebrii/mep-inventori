...
<div class="container mx-auto p-4">
    ...
    <!-- Tombol Tambah Data -->
    <button onclick="toggleModal('addModal')" class="bg-green-500 text-white px-4 py-2 rounded mb-4">Tambah Barang Keluar</button>
    ...
    <div class="bg-white px-4 py-4 border-t-4 border-green-500">    
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border w-36">
                        ...
                        <form action="{{ route('keluar.destroy', $item->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
        ...
        <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-white p-6 rounded shadow w-full max-w-md">
                <h2 class="text-xl font-bold mb-4">Edit Data Barang Keluar</h2>
