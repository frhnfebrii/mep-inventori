...
<div class="container mx-auto p-4 bg-white">
    ...
    <form method="GET" action="{{ route('laporan.index') }}" class="mb-4 flex flex-wrap gap-4 items-center">
        ...
        <div class="mt-6">
            <a href="{{ route('laporan.exportPdf', ['month' => $selectedMonth, 'category' => $selectedCategory]) }}"
               target="_blank"
               class="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded shadow transition duration-200"
>
                Export PDF
            </a>
        </div>
