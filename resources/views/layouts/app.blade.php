        ...
        <ul>
          ...
          <li class="p-2 cursor-pointer">
            ...
            <ul id="submenuBarang1" class="hidden pl-8 mt-2 space-y-1 text-sm text-gray-700 dark:text-gray-300">
              <li class="p-1 hover:text-green-600 cursor-pointer">
                <a href="/electrical" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <li class="p-1 hover:text-green-600 cursor-pointer">
                <a href="/instrument" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li class="p-1 hover:text-green-600 cursor-pointer">
                <a href="/tools" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li class="p-2 cursor-pointer">
            ...
            <ul id="submenuBarang" class="hidden pl-8 mt-2 space-y-1 text-sm text-gray-700 dark:text-gray-300">
              <li class="p-1 hover:text-green-600 cursor-pointer">
                <a href="/masuk" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li class="p-2 hover:bg-gray-100 cursor-pointer">
            <a href="/restok" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
