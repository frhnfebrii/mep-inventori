...
@section('title', 'Data Barang Instrument Part')

@section('mainContent')

<div class="container mx-auto p-4">
    <h1 class="text-2xl font-semibold mb-4">Data Barang Instrument</h1>
        ...
        <tbody class="bg-white">
            ...
            <tr>
                ...
                <td class="px-4 py-2 border w-36">
                    ...
                    <form action="{{ route('instrument.destroy', $part->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
...
<script>
    ...
    function openEditModal(part) {
        ...
        form.action = `/instrument/${part.id}`;
    ...
    const quantityTambah = document.getElementById('tambahQuantity');
